...
export default function StickyBottomCTA({
  ...
  return (
    <div
      ...
      className="fixed bottom-0 left-0 right-0 z-40 lg:hidden bg-[#07090e]/95 backdrop-blur-2xl border-t border-cyan-500/25 pt-2.5 pb-[calc(0.625rem+env(safe-area-inset-bottom,0px))] px-4 sm:px-6 shadow-[0_-10px_35px_rgba(0,0,0,0.95)] select-none"
    >
